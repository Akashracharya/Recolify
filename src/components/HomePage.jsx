      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
        {subjects.map((subject) => (
          <div
            ...
            className="group relative bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 cursor-pointer transition-all duration-300 hover:scale-105 hover:bg-gray-700/50 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/25"
